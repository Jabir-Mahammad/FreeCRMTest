...
public class AppDependentMethods extends DriverScripts {
	...
	public boolean loginToApp(WebDriver oDriver)
	{
		...
		try {
			...
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_UserName_Edit", strUN));
			String strPWD = appInd.getCellData("loginToApp", "TD_Password", 1);
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_Password_Edit", strPWD));
			strStatus+=String.valueOf(appInd.clickObject(oDriver,"obj_Login_Link" ));
			Thread.sleep(4000);
			
			//validate optional short cut element
		//	if(elementPresent(oDriver, "obj_ShortCut_Icon"))
			//{
	...
	public boolean createUser(WebDriver oDriver)
	{
		...
		try {
			...
			//Enter user details
			String strFN = appInd.getCellData("createUser", "TD_FirstName", 1);
			String strLN = appInd.getCellData("createUser", "TD_LastName", 1);
			String strEmail = appInd.getCellData("createUser", "TD_Email", 1);
			String strUser = appInd.getCellData("createUser", "TD_User", 1);
			String strPassword = appInd.getCellData("createUser", "TD_Pwd", 1);
			String strRetype = appInd.getCellData("createUser", "TD_ReType", 1);
			
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_FirstName_Edit", strFN));
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_LastName_Edit", strLN));
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_Email_Edit", strEmail));
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_User_UN_Edit", strUser));
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_User_PWd_Edit", strPassword));
			strStatus+=String.valueOf(appInd.setObject(oDriver, "obj_User_RetypePWd_Edit", strRetype));
			
			//Click on CreateUser button
			strStatus+=String.valueOf(appInd.clickObject(oDriver, "obj_CreateUser_Btn"));
			Thread.sleep(2000);
			strStatus+=String.valueOf(appInd.verifyText(oDriver, By.xpath("//span[text()="+"'"+strLN+", "+strFN+"'"+"]"), "Text", "user1, demo"));
...
public boolean logoutFromApp(WebDriver oDriver)
{
	...
	try {
		...
		strResult+=String.valueOf(appInd.clickObject(oDriver, "obj_Logout_Link"));
		Thread.sleep(2000);
