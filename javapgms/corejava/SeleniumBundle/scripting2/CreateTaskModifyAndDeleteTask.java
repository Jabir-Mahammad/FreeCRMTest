...
public class CreateTaskModifyAndDeleteTask {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(oBrowser!=null)
			{
				...
				strStatus+=String.valueOf(meth.createTask(oBrowser));
				//strStatus+=String.valueOf(meth.modifyTask(oBrowser));
			   // strStatus+=String.valueOf(meth.deleteTask(oBrowser, "Project1"));
