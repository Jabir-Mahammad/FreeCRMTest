...
//finding wether login successfull and create a user, after that delete the same user, finally logout (in chrome)
import org.openqa.selenium.By;
import org.openqa.selenium.chrome.ChromeDriver;

public class CreateAndDeleteUserInActitimeInChrom {
